...
<div class="w3-container" id="designers" style="margin-top: 75px">
	...
	<p>We are lorem ipsum consectetur adipiscing elit, sed do eiusmod
		...
		do eiusmod tempor incididunt ut labore et quis nostrud exercitation
...
<div class="w3-container" id="contact" style="margin-top: 75px">
	...
	<hr style="width: 50px; border: 5px solid red" class="w3-round">
	<p>Do you want us to style your home? Fill out the form and fill me
		in with the details :) We love meeting new people!</p>
	<form action="form.asp" target="_blank">
		...
		<button type="submit"
			class="w3-btn-block w3-padding-large w3-red w3-margin-bottom">Send
			Message</button>
	</form>
</div>